...
namespace Huellitasco.App.Persistencia
{
    public class RepositorioDueno:IRepositorioDueno
    {
        ...
        public IEnumerable<Dueno> GetAllDuenos_(){
            return _appContext.Dueno;
        }

        public Dueno AddDueno(Dueno dueno){
            var duenoAdicionado = _appContext.Dueno.Add(dueno);
        ...
        public Dueno UpdateDueno(Dueno dueno){
            var duenoEncontrado = _appContext.Dueno.FirstOrDefault(d => d.Id == dueno.Id);
        ...
        public void DeleteDueno(int idDueno){
            ...
            if (duenoEncontrado == null)
                return;
            _appContext.Dueno.Remove(duenoEncontrado);
            _appContext.SaveChanges();
        }

        public Dueno GetDueno(int idDueno){
            return _appContext.Dueno.FirstOrDefault(d => d.Id == idDueno);
        }
